...
public class SpaceTabLayout extends RelativeLayout {
    ...
    private void init() {
        ...
        defaultTabOneButtonIcon = getContext().getResources().getDrawable(R.drawable.btn_tips);
        defaultTabTwoButtonIcon = getContext().getResources().getDrawable(R.drawable.btn_inicio);
        defaultTabThreeButtonIcon = getContext().getResources().getDrawable(R.drawable.btn_nosotros);
        defaultTabFourButtonIcon = getContext().getResources().getDrawable(R.drawable.btn_aqui);
    ...
    public void setTabOneIcon(@DrawableRes int tabOneIcon) {
        ...
        //tabOneImageView.setImageResource(R.drawable.btn_tips);
